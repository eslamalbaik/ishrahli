  ...
  return (
    <div className="relative h-auto md:h-[450px] w-full max-w-xs mx-auto border rounded-md border-[#f3f3f3d5] bg-white shadow-lg transition-shadow duration-300 hover:shadow-xl">
      ...
      <div className="p-4">
        ...
        <button className="absolute right-0 bottom-1 bg-[--foreground] hover:bg-[--background] text-white font-semibold mt-4 py-2 px-4 rounded-md flex justify-center items-center gap-2 transition-colors duration-300 w-full">
          أضف إلى السلة
